...
(function (root) {
  ...
  function extractAnswers(rawText) {
    ...
    // Legacy equals pass: kept so that equals-based tests (chained equality,
    // dedup, stop-word, coexist) remain passing. The 2 'low'-confidence tests
    // (L = 200 mH, f = 6.3 MHz) intentionally remain failing until Task B3
    // retrofits this pass with confidence/label fields.
    const combined = labeled.concat(listed);
