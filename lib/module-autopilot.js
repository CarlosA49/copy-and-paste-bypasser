    ...
    function runCurrentItem(stateNow) {
      ...
      if (confirmer && typeof confirmer.waitForCompletion === 'function') {
        ...
        if (!confirmed) {
          ...
          // Prefer the injected handlers.tryMarkCompleteFallback (test seam),
          // fall back to the always-exported module-level helper. Reversing
          // this order would make tests unable to override the fallback.
